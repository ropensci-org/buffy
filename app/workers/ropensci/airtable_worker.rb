  ...
  class AirtableWorker < BuffyWorker
    ...
    def assign_reviewer
      ...
      if gh_user
        ...
        airtable_revs = Airrecord.table(airtable_config[:api_key], airtable_config[:base_id], "reviewers-prod")
        airtable_reviews = Airrecord.table(airtable_config[:api_key], airtable_config[:base_id], "reviews")
